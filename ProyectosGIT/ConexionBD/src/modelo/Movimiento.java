...
public class Movimiento implements Serializable {
    ...
    public String toString() {
        return "Movimiento{" + "claveContrato=" + claveContrato + ", fechaLiquidacion=" + fechaLiquidacion + ", claveBanco=" + claveBanco + ", tipoMoneda=" + tipoMoneda + ", nombreEmpleado=" + nombreEmpleado + ", apellidoPEmpleado=" + apellidoPEmpleado + ", apellidoMEmpleado=" + apellidoMEmpleado + ", claveEmpleado=" + claveEmpleado + ", importeLiquidacion=" + importeLiquidacion + ", importeLiquidacionMxp=" + importeLiquidacionMxp + ", cuentaDeposito=" + cuentaDeposito + ", curp=" + curp + ", fechaIngreso=" + fechaIngreso + ", puestoEmpleado=" + puestoEmpleado + ", deptoEmpleado=" + deptoEmpleado + ", envioCheque=" + envioCheque + ", destinoEnvioCheque=" + destinoEnvioCheque + ", telEnvioCheque=" + telEnvioCheque + ", correoEnvioCheque=" + correoEnvioCheque + ", bancoExtranjero=" + bancoExtranjero + ", domBancoExtranjero=" + domBancoExtranjero + ", paisBancoExtranjero=" + paisBancoExtranjero + ", abaBic=" + abaBic + ", nombreFideiBancoExt=" + nombreFideiBancoExt + ", direccionFideiExt=" + direccionFideiExt + ", paisFideiExt=" + paisFideiExt + ", telFideiExt=" + telFideiExt + ", nombreArchivo=" + nombreArchivo + ", rfc=" + rfc + '}';
    }
